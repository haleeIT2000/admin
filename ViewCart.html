            ...
            <div class="row">
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            <div class="buttons_added" >
                                                <input class="inputQuantity" onChange="updateQuantity(this)"  id='1' " min='1' name='quantity' type='number' value='1' />
                ...
                <div class="col-lg-3 box-fee mt-70 mb-50 pt-3">
                    ...
                    <div class="shipping-fee pt-4">
                        ...
                        <div class="payment">
                            <a href="./payment.html" class="pt-50 pl-50">Tiến hành thanh toán</a>
                        </div>
                    </div>
                </div>
            </div>
