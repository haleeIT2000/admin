...
<head>
    <title>Rau củ tại Orfarm Store</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                ...
                <div class="col-lg-3 order-2 order-lg-1">
                    <div class="orfarm-shop-sidebar">
                        ...
                        <div class="shop-category-widget">
                            ...
                            <ul>
                                <li class="fruit"><a href="./raucusach.html" >Rau củ sạch</a></li>
                        ...
                        <div class="shop-best-product-widget">
                            ...
                            <div class="shop-product">
                                <div class="thumb">
                                    <img src="./image/cà chua.jpg" alt="">
                                </div>
                                <div class="content">
                                    <a href="./productdetail.html">Cà Chua Mộc Châu</a>
                                    <span>45.000đ</span>
                                </div>
                            </div>
                            <div class="shop-product">
                                ...
                                <div class="content">
                                    <a href="./productdetail.html">Cải Bắp Đà Lạt</a>
                                    <span>18.000đ</span>
                                </div>
                            </div>
                            <div class="shop-product">
                                <div class="thumb">
                                    <img src="./image/đậu.jpg" alt="">
                                </div>
                                <div class="content">
                                    <a href="./productdetail.html">Đậu Xanh Hải Dương</a>
                                    <span>23.000đ</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-9 order-1 order-lg-2">
                    <div class="row">
                        <div class="banner-collection pb-5 w-300">
                            <img src="./image/20200929091644852gia-thuc-pham-ngay-299-thi-truong-soi-dong-hon-khi-14-0.jpg"  height="262px" alt="">
                        </div>
                    </div>
