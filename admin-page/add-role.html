                            ...
                            <div class="widget-content widget-content-area add-manage-product-2">
                                <div class="">
                                    ...
                                    <form id="add_form" class="form-horizontal"
                                        action="https://ordertrungquoc.mrdream.vn/admin/blog" method="POST">
                                        <input type="hidden" name="_token"
                                            value="0DHJE7LtR38u80RKTMpabHBIjL7g4R8BSLXt15B5">
                                        ...
                                        <div class="form-group row" id="category">
                                            ...
                                            <div class="col-md-9">
                                                <div class="dropdown bootstrap-select form-control aiz-"><select
                                                        class="form-control aiz-selectpicker" name="category_id"
                                                        ...
                                                        <div class="inner show" role="listbox" id="bs-select-1"
                                                            ...
                                                            <ul class="dropdown-menu inner show" role="presentation"
                                                                ...
                                                                <li><a role="option" class="dropdown-item"
                                                                        id="bs-select-1-1" tabindex="0"><span
                                                                            class="text">
                                                                            Test cat 1 edited
                                                                        </span></a></li>
                                                                <li><a role="option" class="dropdown-item"
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">Tiêu đề Meta</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">Mô tả Meta</label>
                                            <div class="col-md-9">
