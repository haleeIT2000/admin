                            ...
                            <div class="card-section mx-md-auto">
                                <div class="row">
                                    <div class="col-xl col-lg-6 col-md-6 col-sm-6 col-12 mb-2">
                                        <div class="o-cards">
                                            ...
                                            <a href="">
                                                <h5 class="txt-o-placed">Tất cả đơn hàng</h5>
                                            </a>
                                            <div class="row">
                                    ...
                                    <div class="col-xl col-lg-6 col-md-6 col-sm-6 col-12 mb-2">
                                        <div class="o-cards">
                                            <a href="">
                                                <h5 class="txt-o-preparing">Chờ cọc</h5>
                                            </a>
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4 col-4 mt-4">
                                                    <div class="">
                                    ...
                                    <div class="col-xl col-lg-6 col-md-6 col-sm-6 col-12 mb-2">
                                        <div class="o-cards">
                                            <a href="">
                                                <h5 class="txt-o-shipped">Đang mua hàng</h5>
                                            </a>
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4 col-4 mt-4">
                                                    <div class="">
                                    ...
                                    <div class="col-xl col-lg-6 col-md-6 col-sm-6 col-12 mb-2">
                                        <div class="o-cards">
                                            <a href="">
                                                <h5 class="txt-o-arrival">Đang xử lý</h5>
                                            </a>
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4 col-4 mt-4">
                                                    <div class="">
                                ...
                                <div class="row mt-3">
                                    <div class="col-xl col-lg-6 col-md-6 col-sm-6 col-12 mb-2">
                                        <div class="o-cards">
                                            <a href="">
                                                <h5 class="txt-o-arrival">Đang vận chuyển</h5>
                                            </a>
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4 col-4 mt-4">
                                                    <div class="">
                                    ...
                                    <div class="col-xl col-lg-6 col-md-6 col-sm-6 col-12 mb-2">
                                        <div class="o-cards">
                                            <a href="">
                                                <h5 class="txt-o-arrival">Đơn hoàn về kho </h5>
                                            </a>
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4 col-4 mt-4">
                                                    <div class="">
                                    ...
                                    <div class="col-xl col-lg-6 col-md-6 col-sm-6 col-12 mb-2">
                                        <div class="o-cards">
                                            <a href="">
                                                <h5 class="txt-o-arrival">Hoàn thành</h5>
                                            </a>
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4 col-4 mt-4">
                                                    <div class="">
                                    ...
                                    <div class="col-xl col-lg-6 col-md-6 col-sm-6 col-12 mb-2">
                                        <div class="o-cards">
                                            <a href="">
                                                <h5 class="txt-o-arrival">Đã hủy</h5>
                                            </a>
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4 col-4 mt-4">
                                                    <div class="">
                                ...
                                <ul class=" list-unstyled cd-bread mt-20">
                                    <li>
                                        <select name="" id="" class="form-control">
                                            ...
                                            <option value="11">Đang giao</option>
                                            <option value="11">Đang xử lý</option>
                                            <option value="11">Giao thành công</option>
                                        ...
                                        <div class="check-time">
                                            <div style="display: flex">
                                                <span style="margin-top: 10px;">Từ ngày</span><input name="from_date"
                                                    class="form-control" placeholder="Từ ngày" type="date" value="">
                                            </div>
                                            <div style="display: flex;">
                                                <span style="margin-top: 10px;">Đến ngày</span><input name="to_date"
                                                    class="form-control to_date_ed" placeholder="Đế ngày" type="date"
                                                    value="">
                                            </div>
                                        </div>
                                    </li>
                                    <li><button class="btn btn-info" class="form-control"
                                            style="margin-bottom: 10px">Tìm Kiếm</button></li>
                                    <li>
