                            ...
                            <div class="widget-content widget-content-area add-manage-product-2">
                                <form class="row g-3">
                                    <div class="col-md-6 pt-3">
                                        <label for="inputName" class="form-label">Mã nhân viên(ID)</label>
                                        <input type="text" class="form-control" id="inputName"
                                            placeholder="Mã nhân viên(ID)" aria-label="First name">
                                    </div>
                                    <div class="col-md-6 pt-3">
                                    ...
                                    <div class="col-md-6 pt-3">
                                        <label for="inputImage" class="form-label">Ảnh mô tả</label>

                                        <input type="file" class="form-control" placeholder="" name="Chọn ảnh đại diện"
                                            id="inputImage">
                                    </div>
                                    <div class="col-md-6 pt-3">
                                    ...
                                    <div class="col-md-6 pt-3">
                                        <a href="staff.html" class="btn btn-info">Quay lại</a>
                                        <button class="btn btn-danger">Xóa dữ liệu</button>
                                    </div>
                                    <div class="col-md-6 pt-3">
                                        <button type="submit" class="btn btn-warning float-right">Thêm</button>
                                    </div>
                                </form>
                            </div>
                        </div>
