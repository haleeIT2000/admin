                            ...
                            <div class="widget  t-order-widget">
                                <div class="media">
                                    ...
                                    <div class="media-body text-right">
                                        <p class="widget-text mb-0">Doanh số</p>
                                        <p class="widget-numeric-value">98,225</p>
                                    </div>
                                </div>
                                <p class="widget-total-stats mt-2">94% Doanh số mới</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 mb-xl-0 col-lg-6 mb-4 col-md-6 col-sm-6">
                        <div class="widget-content-area  data-widgets br-4" style="background-color: yellowgreen;">
                            <div class="widget  t-order-widget">
                                ...
                                <p class="widget-total-stats mt-2">552 Đơn hàng mới</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-sm-0 mb-4">
                        <div class="widget-content-area  data-widgets br-4" style="background-color: yellowgreen;">
                            <div class="widget  t-customer-widget">
                                ...
                                <p class="widget-total-stats mt-2">390 Khách hàng mới</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="widget-content-area  data-widgets br-4" style="background-color: yellowgreen;">
                            <div class="widget  t-income-widget">
                                ...
                                <p class="widget-total-stats mt-2">2.1 M Doanh thu tuần này</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <ul class="nav justify-content-sm-end justify-content-center monthly-chart-tab nav-pills"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" id="monthly-chart-weekly-tab" data-toggle="pill"
                                                ...
                                                aria-controls="monthly-chart-weekly" aria-selected="true">Theo tuần</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="monthly-chart-yearly-tab" data-toggle="pill"
                                                ...
                                                aria-controls="monthly-chart-yearly" aria-selected="false">Theo năm</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <div class="row mt-3">
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <span class="visitors">Khách ghé thăm : 9,823</span>
                                                        </div>
                                                    </div>
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <span class="page-view">Lượt xem : 21,655</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row mt-3">
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <span class="visitors">Khách ghé thăm : 19,823</span>
                                                        </div>
                                                    </div>
                                                    <div
                                                        class="col-lg-5 col-md-5 col-sm-5 col-12 text-sm-left text-center mb-3 ml-sm-3 px-xl-0">
                                                        <div
                                                            ...
                                                            <span class="page-view">Lượt xem : 61,655</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row mt-3">
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <span class="visitors">Khách ghé thăm : 80,823</span>
                                                        </div>
                                                    </div>
                                                    <div
                                                        class="col-lg-5 col-md-5 col-sm-5 col-12 text-sm-left text-center mb-3 ml-sm-3 px-xl-0">
                                                        <div
                                                            ...
                                                            <span class="page-view">Lượt xem : 1,215,655</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="widget  t-order-widget">
                                        <div class="row">
                                            <div
                                                ...
                                                <p class="t-o-txt mb-3 mb-sm-5 mt-3">Tổng đơn hàng</p>
