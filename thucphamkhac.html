...
<head>
    <title>Các loại thực phẩm khác tại Orfarm Store</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                    ...
                    <div class="orfarm-shop-sidebar">
                        ...
                        <div class="shop-best-product-widget">
                            ...
                            <div class="shop-product">
                                <div class="thumb">
                                    <img src="./image/a8ceb9c05274b502fb0c493236e01a54.webp" alt="">
                                </div>
                                <div class="content">
                                    <a href="./productdetail.html">Bơ Lạt</a>
                                    <span>80.000đ</span>
                                </div>
                            </div>
                            <div class="shop-product">
                                <div class="thumb">
                                    <img src="./image/trung-cut-chua-nhieu-duong-chat-tot-cho-nao-88b-4823246.jpg" alt="">
                                </div>
                                <div class="content">
                                    <a href="./productdetail.html">Trứng Cút</a>
                                    <span>7.000đ</span>
                                </div>
                            </div>
                            <div class="shop-product">
                                <div class="thumb">
                                    <img src="./image/trungga_1-1705.jpg" alt="">
                                </div>
                                <div class="content">
                                    <a href="./productdetail.html">Trứng Gà</a>
                                    <span>50.000đ</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-9 order-1 order-lg-2">
                    <div class="row">
                        <div class="banner-collection pb-5 w-300">
                            <img src="./image/thuc-pham.jpg"  height="262px" alt="">
                        </div>
                    </div>
